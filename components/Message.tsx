...
const BLOCKS = [
  ...
  "Al darle mi propio significado, tambien aproveche para darle un toque matemático, y es que la flor que ves en pantalla esta generada con el ángulo áureo, el mismo que se encuentra en la naturaleza y que se asocia a la belleza y armonía. Belleza que encuentro en vos y armonia que siento cuando estoy a tu lado.",
